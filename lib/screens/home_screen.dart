...
class _HomePageState extends State<HomePage> {
      ...
      body: mqData!.orientation == Orientation.portrait
          ? SingleChildScrollView(
              child: Column(
                ...
                children: [firstCol(), secondCol()],
              ),
            )
          : Row(
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Expanded(flex: 1, child: firstCol()),
                Expanded(flex: 1, child: secondCol())
              ],
            ),
    );
  }
  ...
  Widget firstCol() {
    return Column(
      mainAxisAlignment: mqData!.orientation == Orientation.landscape
      ...
      children: [
        ...
        SizedBox(
          ...
          child: BlocBuilder<MarsBloc, MarsState>(builder: (context, state) {
